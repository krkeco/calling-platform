	...
	render() {
	    ...
	    return (
	      <div className="flexRow">
	        ...
	        <Location name="hand" tasks={tasks} onDragOver={this.onDragOver} onDrop={this.onDrop} />
	        <Location name="jerusalem" tasks={tasks} onDragOver={this.onDragOver} onDrop={this.onDrop} />
	        <Location name="babylon" tasks={tasks} onDragOver={this.onDragOver} onDrop={this.onDrop} />
	        <Location name="nineveh" tasks={tasks} onDragOver={this.onDragOver} onDrop={this.onDrop} />
