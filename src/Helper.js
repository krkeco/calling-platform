    ...
    <div className={titleBar}>
      <div className="flexRow">
        <div className="flexCol helperText">
          ...
          <div className="hintText">
            ->You have a 10 card deck: 6 gold, 3 influence, 1 character
          </div>
          <div className="hintText">->Every turn you draw 5 cards</div>
          <div className="hintText">
            ->Drag cards on location battlefields to play them
          </div>
          <div className="hintText">
            ->You can see how much gold and influence you have on a location
            under your name in the location's battlefield
          </div>
          <div className="hintText">
            ->To see a card, hover your mouse over the card- The cost is on top,
          ...
          <div className="hintText">
            ->There are many special rules on cards: Click on a location's (?)
        ...
        <div className="flexCol helperText">
          ...
          <div className="hintText">
            ->If you have enough gold, click on a card to buy it, it will go in
            your discard
          </div>
          <div className="hintText">
            ->It's a good idea to buy some cards with gold early on so you can
            buy more expensive cards
          </div>
          <div className="hintText">
        ...
        <div className="flexCol helperText">
          ...
          <div className="hintText">
            ->At the end of a round if you have more influence than any other
            player on the location PLUS the location's influence you become
            influencer!
          </div>
          <div className="hintText">
          ...
          <div className="hintText">
            ->Influencing locations also gives you a powerful influence card
            next turn!
          </div>
          <div className="hintText">
