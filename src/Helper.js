    ...
    return (
        <div className={titleBar}>
          ...
          <div className="flexRow">
            ...
            <div className="hintText">->There are many special rules on cards: Click on a location's (?) button to see more special rules</div>
            
          </div>
          <div style={{flex:1,padding:5}} className="flexCol helperText">
            <p>Gold and Markets:</p>
            <div className="hintText">->Play cards that have gold to get more cards from the market</div>
          ...
          <div style={{flex:1,padding:5}} className="flexCol helperText">
           ...
           <div className="hintText">->At the end of a round if you have more influence than any other player on the location PLUS the location's influence you become influencer!</div>
